...
if _name_ == '_main_':
    ...
    model_weights = torch.load('saved-model-2025-01-04-11-10-07/model.pth')
    ...
    for sample_i in range(0, 5):
        ...
        disparity_map_siamese = disparity_map_nn(model=model, img_l=img_l, img_r=img_r, padding_size=padding_size,
                                                 max_disparity=64, device=device)
